...
3. **Implement** — hand the whole plan to the Implementer (`/codex-work`).
4. **Accept** — reconcile the Implementer's report and diff against the plan; rerun the checks. Findings go back to the Implementer, not into your own editor.
