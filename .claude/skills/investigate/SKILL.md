...
4. **Report** — the root cause with its evidence chain and your confidence in it; impact and similar at-risk code; the suggested fix (for /execute) with its risk; the rejected hypotheses and why; open questions when the cause isn't confirmed.
