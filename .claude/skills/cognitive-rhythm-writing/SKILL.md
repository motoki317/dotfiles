...
description: 説明的な文章に緩急（認知モードの切替と未回収の緊張の管理）を設計する規範。読み物として読ませる章・記事・解説文を書くとき、密度はあるが平坦な文章を診断・修正するときに使用する。
---
...
作業前に `$HOME/.claude/skills/tech-writing/SKILL.md` と `$HOME/.claude/skills/tech-writing/references/japanese.md` を読む。
